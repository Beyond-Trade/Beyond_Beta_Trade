...
import { default as create_metamask, metamask_deep_link} from '@beyond/metamask';
import {isMobile} from '@walletconnect/browser-utils';
import {WalletState} from '@beyond/wallet_common';
...
class Wallet extends EventEmitter {
	...
	async select_wallet(wallet_type)
	{
		...
		const w = (wallet_type === 'metamask')
			? create_metamask()
			: (await import('@beyond/walletconnect')).default({bridge: this.bridge});
